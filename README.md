...
| [evidence-repo-audit](skills/evidence-repo-audit/SKILL.md) | Proof-backed adversarial repository and multi-repo audits with finding registers and safe execution roadmaps | Comprehensive audits, technical due diligence, blind-spot reviews, or release-readiness decisions |
